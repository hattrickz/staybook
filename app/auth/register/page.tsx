        ...
        <div className="card p-8">
          ...
          <div className="grid grid-cols-2 gap-2 mb-6 p-1 bg-surface-secondary rounded-xl">
            {(['customer', 'manager'] as const).map((r) => (
              <label key={r} className={`cursor-pointer rounded-lg py-2.5 px-3 text-center text-sm font-medium transition-all ${
                selectedRole === r ? 'bg-white shadow-card text-brand' : 'text-ink-secondary hover:text-ink-primary'
              }`}>
