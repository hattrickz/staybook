...
# staybook
Modern multi-hotel booking platform built with Next.js, TypeScript, GraphQL, and Docker. Features hotel discovery, room reservations, user dashboards, and hotel management tools.
